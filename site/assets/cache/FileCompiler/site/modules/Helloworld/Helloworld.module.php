...
class Helloworld extends \ProcessWire\WireData implements \ProcessWire\Module {
	 ...
	 * 
	 * Interesting note: \ProcessWire\Page::render() is itself a hook, added by /wire/modules/PageRender.module,
	...
	public function pageRenderHookExample($event) {
		...
		// since the hook is to \ProcessWire\Page::render.
		$page = $event->object; 
	...
	/**
	 * Hook to \ProcessWire\Page::hello
	 * 
