 ...
 * 
 * Note: to make any text translatable, wrap it with \ProcessWire\__('your text'); 
...
$config = array(
	...
	'useHello' => array(
		'type' => 'radios',
		'label' => \ProcessWire\__('Enable hello world message?'), 
		'description' => \ProcessWire\__('This will make your hello world message display at the bottom of every page.'),
		'notes' => \ProcessWire\__('The hello message will only be shown to users with edit access to the page.'), 
		'options' => array(
			1 => \ProcessWire\__('Yes'),
			0 => \ProcessWire\__('No'),
		),
		'value' => 0,
	),
